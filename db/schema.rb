...
ActiveRecord::Schema.define(version: 2020_07_30_145531) do
  ...
  create_table "strolls", force: :cascade do |t|
    ...
    t.index ["doctor_id"], name: "index_strolls_on_doctor_id"
    t.index ["patient_id"], name: "index_strolls_on_patient_id"
  end
